...
<div class="container-fluid">
  <div class="row">
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column ">
          ...
          <li class="nav-item pb-2" >
            <a class="nav-link active" href="modify_tech.php">
              <span data-feather="gitlab"></span>
              Create/Delete Teacher
            </a>
          </li>
          <li class="nav-item pb-2" >
            <a class="nav-link" href="modify_stud.php">
    ...
    <input type="button" class="btn btn-outline-info" name="addTeach" onclick="location.href='add_teacher.php'" id="addTeach" value="Add A Teacher" >
    <hr>

    
    <h1>All Enrolled Teachers</h1>
    <div class="table-responsive animated fadeInUp">
            <table class="table table-striped table-sm">
            <thead>
                 <tr>
                   <th width="130px">Faculty ID</th>
                   <th>Faculty Name</th>
                   <th>Options</th>
                 </tr>
               </thead>
