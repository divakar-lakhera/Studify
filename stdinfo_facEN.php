...
if(isset($_POST['sub'])){
  ...
  $qu="Insert into collevent values('$noc','$mt');";
  mysqli_query($con,$qu);
  mysqli_close($con);
}
...
<html lang="en">
  <head>
    ...
    <title>AMS|Event Notification</title>
...
<div class="container-fluid">
  <div class="row">
    ...
    <p class="display-4 mt-4 animated fadeInDown">Create Event Notification</p> 
      <hr>
      <form class="form group " method="POST" >
      <input type="text" class="form-control animated fadeInUp"placeholder="Name Of College" name="noc" autofocus required>
      <br>
      <textarea class="form-control animated fadeInUp h5" name="nt" rows="10" placeholder="Description of Event" required></textarea>
      <br><br>
